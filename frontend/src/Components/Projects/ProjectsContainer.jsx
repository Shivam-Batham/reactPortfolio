...
import locationmaster from "./locationmaster.png"
    ...
    <div className={darkmode? "rounded dark-theme":"rounded light-theme"}>
        ...
        >
          <div className="flex place-content-between">
            <h2 className='uppercase font-semibold'>Location Master</h2>
            <h2>
            <Link className="btn p-2 border mx-auto my-4 rounded-md px-4" to="https://locationsmaster.vercel.app/">
          ...
          <div className="mt-4 grid gap-2 grid-cols-6">
            <div className="sm:col-span-2 col-span-6">
              <img src={locationmaster} className="temp rounded object-fill w-[100%] h-[12rem]" />{" "}
            </div>
            <ul className="sm:col-span-4 col-span-6">
              <li>
                <p className="">
                  <span className="w-1 h-1 bg-blue-400  rounded-full inline-block m-1"></span>
                  Location Master is a Full-stack application built in Next.js & Express that provides a list of your visited location.
                </p>{" "}
              </li>
              <li>
                <p>
                  <span className="w-1 h-1 bg-red-400   rounded-full inline-block m-1"></span>
                  It hepls you remembering the location you have visited in the past
                </p>{" "}
              </li>
              ...
              <li>
                <p>
                 ...
                 Also showing some popuplar location for future visit.
                </p>{" "}
              </li>
              <li className="flex">
                <p>
